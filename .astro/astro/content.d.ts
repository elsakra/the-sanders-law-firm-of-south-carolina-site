...
"alcohol-licensing-and-hospitality.md": {
  ...
  slug: "alcohol-licensing-and-hospitality";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"business-law-and-litigation.md": {
	id: "business-law-and-litigation.md";
  slug: "business-law-and-litigation";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
...
"disability-claims-erisa.md": {
	id: "disability-claims-erisa.md";
  slug: "disability-claims-erisa";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"government-relations.md": {
	id: "government-relations.md";
  slug: "government-relations";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"professional-licensing.md": {
	id: "professional-licensing.md";
  slug: "professional-licensing";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"raffles-sweepstakes-gaming.md": {
	id: "raffles-sweepstakes-gaming.md";
  slug: "raffles-sweepstakes-gaming";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
